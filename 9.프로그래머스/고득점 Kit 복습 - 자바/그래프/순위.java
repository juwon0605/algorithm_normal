...
class Solution {    
    ...
    void saveWinner(int loser){
        for(int i = 0; i < loseGraph[loser].size(); ++i){
            int winner = loseGraph[loser].get(i);
    ...
    void saveLoser(int winner){
        for(int i = 0; i < winGraph[winner].size(); ++i){
            int loser = winGraph[winner].get(i);
