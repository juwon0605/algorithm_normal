    ...
    public int solution(int[][] rectangles, int characterX, int characterY, int itemX, int itemY) {
        ...
        while(!Q.isEmpty()){
            ...
            for(int k = 0; k < 4; ++k){
                ...
                if(ii < 1 || ii > 50*2 || jj < 1 || jj > 50*2 ||
                  map[ii][jj] == 0 || distances[ii][jj] != 0 || !isMovable(ii,jj)){
                    continue;
                }
